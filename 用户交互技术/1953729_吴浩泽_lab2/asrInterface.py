...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.voiceFig.setGeometry(QtCore.QRect(70, 50, 200, 100))
        self.voiceFig.setText("")
        self.gif = QMovie("icon/voice2.gif")
        ...
        self.label_5.setGeometry(QtCore.QRect(60, 390, 300, 51))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "3. Surf the Internet  by saying\"web\" or \"web page\" "))
