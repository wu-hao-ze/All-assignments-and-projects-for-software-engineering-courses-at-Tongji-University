  ...
  <div>
    ...
    <el-main id="con">
      ...
      >
        ...
        <el-form-item label="性别" prop="gender" style="width:350px;">
        ...
        <el-form-item label="所在学院" prop="institution" style="width:350px;">
          <el-input v-model="ruleForm.institution"></el-input>
        </el-form-item>
        <el-form-item label="专业" prop="major" style="width:350px;">
